...
export default function ProcessSection() {
  ...
  const processSteps = [
    {
      image:
        'https://images.pexels.com/photos/7876655/pexels-photo-7876655.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
      title: 'SITE PREPARATION & PLANNING',
      description:
        'Thorough site assessment, excavation, and preparation to ensure proper drainage and foundation stability for your concrete project.',
    },
    {
      image: '/pouring.jpg',
    ...
    },
    {
      ...
      description:
        'Professional finishing techniques including smoothing, texturing, and decorative treatments to achieve the perfect look and feel.',
    },
    {
      image:
